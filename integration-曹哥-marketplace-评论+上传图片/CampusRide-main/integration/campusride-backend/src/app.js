...
import marketplaceMessagesRoutes from './routes/marketplace-messages.routes.js';
...
// app.use('/api/v1/marketplace', commentsRoutes); // 已在 marketplaceRoutes 中处理
app.use('/api/v1/marketplace', marketplaceMessagesRoutes);
